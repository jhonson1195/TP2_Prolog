...
%Caso0
%alerta(C,P, M, Co,Ni,E, F, H):- sismo(F,H,C,P,_,M,_,_) , M<4.0, Ni = 'no genera alerta' ,Co ='ninguno', comparafecha(F, E).

%Caso1
alerta(C,P, M, Co,Ni,E, F, H):- sismo(F,H,C,P,Po,M,_,_) , M>=4.0, M=<5.9 ,riesgo(P,C,Ni),zonariesgo4_5(Po, Co, Ni), comparafecha(F, E).
%Caso2
alerta(C,P, M, Co,Ni,E, F, H):- sismo(F,H,C,P,Po,M,_,_) , M>=6.0, M=<7.9 ,riesgo(P,C,Ni),zonariesgo6_7(Po, Co, Ni), comparafecha(F, E).
%Caso3
alerta(C,P, M, Co,Ni,E, F, H):- sismo(F,H,C,P,Po,M,_,_) , M>=8.0, riesgo(P,C,Ni),zonariesgo8(Po, Co, Ni), comparafecha(F, E).
